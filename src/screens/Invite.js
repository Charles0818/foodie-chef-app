...
const Header = () => {
  return (
    <View style={[styles.row, styles.alignItems_center, styles.justifyContent_between, styles.bg_white, styles.boxShadowGray_sm, {height: 50}]}>
      <View style={[{flex: 4}]}>
        <Text style={[,styles.fontWeight_700, styles.text_center, styles.font_md]}>Invite & Earn</Text>
      </View>
      <Button style={[styles.flexCenter, {width: 50, height: 50, borderRadius: 25, flex: .5}]}>
